...
if (typeof(Vue)!=='undefined') {
    ...
    Vue.component('pagination', {
        template: '<ul class="uk-pagination" v-if="page_count > 1">' +
                ...
                '<li v-if="page_count > 3 && page_index > 1"><a v-attr="onclick:\'gotoPage(1)\'" href="#0"><span v-text="1"></span></a></li>' + 
                '<li v-if="page_count > 3 && page_index > 2"><span>...</span></li>' + 
                '<li class="uk-active"><span v-text="page_index"></span></li>' + 
                '<li v-if="page_count > 3 && page_index < page_count - 1"><span>...</span></li>' + 
                '<li v-if="page_count > 3 && page_index != page_count"><a v-attr="onclick:\'gotoPage(\'+ page_count +\')\'" href="#0"><span v-text="page_count"></span></a></li>' + 
